...
], key=lambda brand: brand[5])

#filtered_cars = sorted(filtered_cars, key=lambda brand: brand[5])
print(filtered_cars)
print('List of cars which are follows a criteria:')
for car in filtered_cars:
    if car == filtered_cars[5]:
        break
    else:
        print(car)